...
var objekt = "aldechydy_772.obj";
var objektM = "aldechydy_772.mtl";


function zmiana() {
    if (objekt === "aldechydy_772.obj") {
        objekt = "aldechydy_772_b.obj"
        objektM = "aldechydy_772_b.mtl"
        main();

    } else if (objekt === "aldechydy_772_b.obj") {
        objekt = "aldechydy_772.obj";
        objektM = "aldechydy_772.mtl";
        main();
    } else if (objekt ==="aldechyd_alifateczny_772_js.obj"||"aldechyd_aromatyczny_772_js.obj"){
        objekt = "aldechydy_772_b.obj"
        objektM = "aldechydy_772_b.mtl"
        main();
    }
...
function alifatyczny() {
     ...
     objekt = "aldechyd_alifateczny_772_js.obj";
     objektM = "aldechyd_alifateczny_772_js.mtl";
     console.log("alifatyczny");
     main();
    
}

function aromatyczny() {
    objekt = "aldechyd_aromatyczny_772_js.obj";
    objektM = "aldechyd_aromatyczny_772_js.mtl";
    console.log("aromatyczny");
     main();
}
